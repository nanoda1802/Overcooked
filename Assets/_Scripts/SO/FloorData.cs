...
{
    [SF] private int floorLayerIdx = 3;
    [SF] private int ignoreRaycastLayerIdx = 2;
    /* Find Floors */
    [Header("[ Detect ]")]
    ...
    public int FloorLayerIdx => floorLayerIdx;
    public int IgnoreRaycastLayerIdx => ignoreRaycastLayerIdx;
